...
var risposta2 = prompt("Che linguaggio si usa per modificare il contenuto in un sito?");
if (risposta2.toUpperCase() === "CSS") {
	rispEsatte +=1;
};
var risposta3 = prompt("Che linguaggio si usa per far interagire l'utente?");
if (risposta3.toUpperCase() === "JAVASCRIPT") {
	rispEsatte +=1;
};
var risposta4 = prompt("Che frutto è il simbolo dell'apple?");
if (risposta4.toUpperCase() === "MELA") {
	rispEsatte +=1;
};
var risposta5 = prompt("Chi ha fondato Microsoft?");
